  ...
  return (
    ...
    <Container fluid className="contact">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="fork-btn-inner bg-primary">{i18n.t('contact.send')}</button>
      </form>
      <Particle />
    </Container>
    </div>
...
const renderAlert = () => (
  ...
  <Container fluid className="contact-section" style={{ justifyContent: "center", padding: "150px" }}>
    <p className="text-info"><h2>{i18n.t('contact.your-message-was-sent-successfully')}</h2></p>
  </Container>
)
